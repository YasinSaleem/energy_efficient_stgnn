...
from energy_optimized_continual_learning import run_aggressive_continual_learning  # ✅ FIXED
...
def main():
    ...
    try:
        ...
        results = run_aggressive_continual_learning()  # ✅ FIXED
        ...
        if emissions is not None:
            ...
            # Get total time from results
            total_time = results.get('total_time_sec', 0)
            if 'energy' in results:
                total_time = results['energy'].get('total_time_sec', total_time)
            ...
            with results_path.open("w") as f:
                json.dump(results, f, indent=2, default=str)  # ✅ Added default=str for safety
